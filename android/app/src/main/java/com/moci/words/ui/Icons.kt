...
object MociIcons {
    ...
    val Eye = icon(
        "eye",
        "M12 5C7 5 2.7 8.1 1 12c1.7 3.9 6 7 11 7s9.3-3.1 11-7c-1.7-3.9-6-7-11-7Zm0 11.5A4.5 4.5 0 1 1 16.5 12 4.5 4.5 0 0 1 12 16.5ZM12 9a3 3 0 1 0 3 3 3 3 0 0 0-3-3Z",
    )
    val EyeOff = icon(
        "eye_off",
        "M12 5C7 5 2.7 8.1 1 12c1.7 3.9 6 7 11 7s9.3-3.1 11-7c-1.7-3.9-6-7-11-7Zm0 11.5A4.5 4.5 0 1 1 16.5 12 4.5 4.5 0 0 1 12 16.5ZM12 9a3 3 0 1 0 3 3 3 3 0 0 0-3-3Z",
        "M3.2 4.6 4.6 3.2 20.8 19.4 19.4 20.8Z",
    )
